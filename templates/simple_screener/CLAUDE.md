...
This is a template directory for an n8n workflow called "simple_screener" within a larger n8n templates repository. The workflow is designed to perform strategic sector and company screening for top U.S. companies across promising sectors, with automated Telegram notification delivery.
